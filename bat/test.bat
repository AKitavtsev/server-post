...
curl -v POST http://localhost:3000/draft/2.0202111091126065c8b019cf55009a53f6ba5de31eec170 -d "{\"title\":\"John Lennon\", \"category\":6, \"tags\":[4,5],  \"t_content\":\"...Lennon was shot and killed in 1980\", \"main_photo\":2, \"other_photos\":[1]}"
curl -v http://localhost:3000/publish/2.0202111091126065c8b019cf55009a53f6ba5de31eec170/2
curl -v POST http://localhost:3000/draft/2.0202111091126065c8b019cf55009a53f6ba5de31eec170 -d "{\"title\":\"Paul McCartny\", \"category\":7, \"tags\":[4,6],  \"t_content\":\"...McCartney remain musically active\", \"main_photo\":3, \"other_photos\":[]}"
curl -v http://localhost:3000/publish/2.0202111091126065c8b019cf55009a53f6ba5de31eec170/3
curl -v POST http://localhost:3000/draft/2.0202111091126065c8b019cf55009a53f6ba5de31eec170 -d "{\"title\":\"George Harrison\", \"category\":8, \"tags\":[4],  \"t_content\":\"...Harrison died of lung cancer in 2001\", \"main_photo\":3, \"other_photos\":[1]}"
